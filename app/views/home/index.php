            ...
            <div class="p-3 sm:p-4 lg:p-5 flex flex-col flex-grow bg-white">
             ...
             <?php
                ...
                <button onclick="event.stopPropagation(); addToCart(<?= $product['id'] ?>);" 
                        class="w-full bg-amber-400 hover:bg-amber-500 py-2.5 rounded-lg font-black text-[10px] sm:text-xs text-white uppercase tracking-widest shadow-md hover:shadow-amber-500/40 transition-all active:scale-95">
